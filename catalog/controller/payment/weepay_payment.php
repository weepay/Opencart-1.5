...
class ControllerPaymentWeepayPayment extends Controller
{
    ...
    private $order_prefix = "opencart15X_";
    ...
    public function index()
    {
        ...
        $this->data['form_class'] = $this->config->get('weepay_payment_form_type');
        $this->data['form_type'] = $this->config->get('weepay_payment_checkout_type');
            ...
            if ($postData['isSuccessful'] == 'False') {
                ...
                if ($installment > 1) {
                    ...
                    $this->db->query("INSERT INTO " . DB_PREFIX . "order_total SET order_id = '" .
                        ...
                        "',  title = '" . $this->db->escape('Taksit Komisyonu') . "', "
                        . "text = '" . $this->db->escape($installment_fee_variation * $exchange_rate) . $currencySymbol . "', `value` = '" .
                    ...
                    $this->model_checkout_order->update($order_id, $this->config->get('weepay_payment_order_status_id'), $message, false);
                    ...
                    $this->model_checkout_order->update($this->session->data['order_id'], $this->config->get('weepay_payment_order_status_id'), $message, false);
                }
