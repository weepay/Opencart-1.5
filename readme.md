...
# Getting Started
  ...
  - Supported version  1.5.0.0 - 1.5.X.X;
...
* Download the source [Opencart 1.5.x Last version releases](https://github.com/weepay/Opencart-1.5/releases/), just copy all the files in the zip to your OpenCart directory.
